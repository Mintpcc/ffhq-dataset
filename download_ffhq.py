...
def run(tasks, **download_kwargs):
    ...
    with open(json_spec['file_path'].encode('utf-8'), 'r+') as f:
...
def run_cmdline(argv):
    ...
    parser.add_argument('--num_threads',        help='number of concurrent download threads (default: 32)', type=int, default=4, metavar='NUM')
